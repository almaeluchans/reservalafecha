...
<text x="50%" y="60%" text-anchor="middle" class="svg-text-bg">Alma</text>
<text x="50%" y="60%" text-anchor="middle" class="svg-text-writing">Alma</text>
<text x="50%" y="120%" text-anchor="middle" class="svg-text-bg">XV</text>
<text x="50%" y="120%" text-anchor="middle" class="svg-text-writing">XV</text>
</svg>
...
-->
<section class="rsvp-section" style="padding: 20px 20px;">
<h3>CONFIRMACIÓN</h3>
...
font-size: 8rem; /* 4rem aprox igual a la solicitud */
fill: transparent;
